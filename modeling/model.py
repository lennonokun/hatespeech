...
from adapters import AutoAdapterModel, LoRAConfig, DiReftConfig
...
class HateModule(BaseMultiModel):
  def __init__(self, config):
    ...
    self.model.add_adapter("my_adapter", config=DiReftConfig(
      r=config["adapter_r"],
    ...
    norm_layers = [
      ...
      if ("layer.10" in k or "layer.11" in k) and "reft" in k
    ]
